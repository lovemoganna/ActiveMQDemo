...
public class ActiveMqTest {
    ...
    public void testQueueProducer() throws JMSException {
        ...
        try {
            ...
            // 5.使用Session对象创建一个Destination对象,两种形式Queue,topic,现在使用queue对象,给这个队列起名叫t-queue.
            Queue queue = session.createQueue("te-queue");
            ...
            // 7.创建一个Message对象,可以使用TextMessage.
                 ...
                 */
             textMessage = session.createTextMessage("hi ActivqMQ!");
